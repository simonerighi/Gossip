...
prop_coop_good=prop_coop;

touched_good=zeros(maxval,Niter); 
touched_good(:,:)=NaN;

Simnamebase='OutDatedInfoVsAmountGossip_populationsize';
...
while initial<=maxval
    ...
    for i=1:100
        disp(num2str(i));
        SimName=[Simnamebase '_' num2str(initial) '_' num2str(final) '_' num2str(i) '.mat']; %create namefile
